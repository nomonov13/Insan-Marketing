  ...
  return (
    ...
    <div>
       ...
       <div className='space-y-10'>
           ...
           <p className='text-black'>Biz brendlarni raqamli marketingini yuritamiz. Soddaroq <br /> qilib aytganda, internet orqali har qanday biznesning <br /> raqamli marketingini yurg'izib, ularga mijozlarini ko'payishi uchun xizmat qilamiz.</p>
